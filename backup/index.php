        ...
        <div class="row justify-content-evenly text-center">
            ...
            <div class="col">
                <a href="/analisis-funcional.php">
                    <div class="card" style="width: 14rem;">
                        <img src="img/AF2.svg" class="card-img-top" alt="Analista Funcional">
                        <div class="card-body ">
            ...
            <div class="col justify-content-center">
                <a href="/infraestructura-ti.php">
                    <div class="card" style="width: 14rem;">
                        <img src="img/ITI2.SVG" class="card-img-top" alt="Infraestructura TI">
                        <div class="card-body">
            ...
            <div class="col justify-content-center">
                <a href="/desarrollo-software.php">
                    <div class="card" style="width: 14rem;">
                        <img src="img/DS2.svg" class="card-img-top" alt="Desarrollo de software">
                        <div class="card-body">
