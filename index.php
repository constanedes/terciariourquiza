        ...
        <div class="row justify-content-evenly text-center">
            <div class="col">
                <a href="/analisis-funcional.php">
                    <div class="card" style="width: 14rem;">
                        <img src="img/af.jpeg" class="card-img-top" alt="Analista Funcional">
                        <div class="card-body ">
            ...
            <div class="col justify-content-center">
                <a href="/infraestructura-ti.php">
                    <div class="card" style="width: 14rem;">
                        <img src="img/ITI.jpg" class="card-img-top" alt="Infraestructura TI">
                        <div class="card-body">
            ...
            <div class="col justify-content-center">
                <a href="/infraestructura-ti.php">
                    <div class="card" style="width: 14rem;">
                        <img src="img/DS.jpg" class="card-img-top" alt="Desarrollo de software">
                        <div class="card-body">
    ...
    <div class="container espacio rounded p50" id="novedades">
        ...
        <section id="finales">
            ...
            <article class="border border-primary rounded espacio p25">
                ...
                <p>Formulario de inscripción: https://forms.gle/uvhBHPgNkV2qSLmk9
                    Cronograma: DICIEMBRE_2022_AF</p>
            </article>
            ...
            <article class="border border-warning rounded espacio">
                ...
                <a class="btn btn-primary" type="button">Formulario de inscripción</a>
                <p>Cronograma: DICIEMBRE_2022_AF</p>
            </article>
        </section>
        <section id="inscripción">
            <h3>INSCRIPCIÓN 2022</h3>
            <p>Podrá realizar en el siguiente formulario la INSCRIPCIÓN PARA PRIMER AÑO 2022. Disponible on-line desde 16/11/2021 y turnos presenciales a partir del 23/11/2021 hasta el 17/12/2021.</p>
            <p>No hay más cupos disponibles para ingreso a 1er año. Más información de nuevas fechas de apertura de pre-inscripción en el formulario.</p>
            <p>Formulario de trámites del Nivel Terciario de la Escuela Superior de Comercio J. J. Urquiza N° 49 de Rosario.
                https://forms.gle/Uo1UKSJSqmNdoDhG7</p>
        </section>
        <section id="calendario">
            <h3>CALENDARIO AÑO 2022</h3>
            <ul id="fechas">
                <li><strong>07/02 al 11/02</strong>: Inscripción de alumnos a Exámenes Finales 1º Turno (1º llamado).</li>
                <li><strong>21/02 al 18/03</strong>: Inscripción de alumnos a Exámenes Finales 1º Turno (2º llamado).</li>
