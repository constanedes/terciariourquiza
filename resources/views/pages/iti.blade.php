...
<section>
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                <th scope="row">2</th>
                <td>Unidad de Definición Institucional</td>
                <td>Cuatr. 2</td>
                <td>3</td>
                <td>-</td>
            </tr>
            ...
            <tr>
                <th scope="row">4</th>
                <td>Física Aplicada a las Tecnoligías de la información</td>
                <td>Anual</td>
                <td>3</td>
                <td>-</td>
            </tr>
            ...
            <tr>
                <th scope="row">8</th>
                <td>Infraestructura de Redes 1</td>
                <td>Anual</td>
                <td>4</td>
                <td>-</td>
            </tr>
...
<section>
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            <tr>
                <th scope="row">1</th>
                <td>Problematica Socio Contemporáneas</td>
                <td>Cuatr. 1</td>
                <td>3</td>
                <td>-</td>
            </tr>
            ...
            <tr>
                <th scope="row">7</th>
                <td>Infraestructura de Redes 2</td>
                <td>Anual</td>
                <td>4</td>
                <td>-</td>
            </tr>
            <tr>
                <th scope="row">8</th>
                <td>Practica Profesionalizante 1</td>
                <td>Anual</td>
                <td>4</td>
                <td>-</td>
            </tr>
