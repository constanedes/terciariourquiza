...
<div class="container mt-5 bg-secondary">
    <div class="row mb-3">
        <img src=" {{ asset('img/DS2.png') }}" class="img-fluid mx-auto d-block" alt="isologotipo Desarrollo en sistemas" style="width: 30% ;" alt="Desarrollo Software">
    </div>
    <div class="row p-3">
        <p>
            ...
            Estos artefactos suelen integrarse en aplicaciones o subsistemas que interactúan entre sí, con otras aplicaciones
            ya
...
<div class="container text-center">
    ...
    <div class="row row-cols-1 row-cols-lg-3 g-2 g-lg-3">
      <div class="col">
        <div class="p-3 border bg-light">
            <img class="img-fluid mx-auto d-block" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/html5/html5-original-wordmark.svg" /></div>
      </div>
      <div class="col">
        <div class="p-3 border bg-light ">
            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/css3/css3-original-wordmark.svg" /></div>
      </div>
      <div class="col">
        <div class="p-3 border bg-light">
  ...
  <div class="container text-center">
    ...
    <div class="row row-cols-1 row-cols-lg-3 g-2 g-lg-3">
        <div class="col">
            <div class="p-3 border bg-light">
                <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/php/php-original.svg" /></div>
          </div>
          <div class="col">
            <div class="p-3 border bg-light">
                <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/apache/apache-original-wordmark.svg" /></div>
          </div>
          <div class="col">
            <div class="p-3 border bg-light">
                <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mysql/mysql-original-wordmark.svg" /></div>
          </div>
        </div>
    </div>
    ...
    <div class="container text-center">
        ...
        <div class="row row-cols-1 row-cols-lg-1 g-1 g-lg-1 text-aling-center">
            <div class="col">
                <div class="p-3 border bg-light">
                    <img class="img-fluid mx-auto d-block" style="width: 30%;" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/python/python-original-wordmark.svg" /></div>
              </div>
            </div>
        </div>
