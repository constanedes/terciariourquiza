...
<div class="container">
    <div class="container-fluid p-5 pt-1 border border-secondary rounded">
        <form
            class="row g-3 needs-validation m-3 p-5"
        ...
        >
            ...
            <div
                class="row py-3 mb-3 rounded  opacity-75  "
            >
                <div class="col-md text-dark fw-semibold bg-secondary">
                    <ol class="list-group list-group-numbered shadow-lg border border-dark border-top-0 ">
                        <li class="list-group-item fw-bold"><a class="text-decoration-none" href="#formulario">Complete sus Datos Personales</a> </li>
                        ...
                        <li class="list-group-item fw-bold">Si había cupo en la carrera, saque turno presencial para <span>presentar la documentación obligatoria:</span>
                            <ul class="fw-normal">
                                <li>Formulario de Inscripción a Primer Año en formato papel impreso y completo
                                    <a class="text-decoration-none" href="https://drive.google.com/file/d/1Nw70ae2aUaPFhw-NB49ETL0luFaAZAjA/view" target="_blank" rel="noopener noreferrer">Visualizar, descargar e imprimir Formulario de Inscripción formato papel</a></li>
                                <li>Si finalizó la secundaria:
                                    <ul><li>Certificado de Estudios Secundarios (fotocopia autenticada)</li></ul>
                                </li>
                                <li>Si está cursando la secundaria:
                                    <ul><li>Constancia de alumno regular del último año del nivel</li></ul>
                                </li>
                                <li>Partida de nacimiento (fotocopia autenticada y actualizada)</li>
                                <li>Fotocopia del DNI</li>
                                <li>Certificado de Buena Salud emitido por entidad pública o privada sin estampillar</li>
            ...
            <div
                class="row py-2 mt-1 rounded opacity-75 "
            >
                <div class="col-md text-dark">                    
                    <ul class="list-group-item shadow-lg border border-dark border-top-0">
                        ...
                        <li class="list-group-item">Disponga del comprobante de inscripción firmado y sellado por la Institución Educativa</li>
            ...
            <div class="col-md-6 form-label form-date mt-1">
                <label class="form-label form-date__label" for="input-date"
                    >Fecha Nacimiento</label
                >
                <input
                    class="form-control form-date__input"
                    type="date"
                    id="input-date"
                    name="birthday"
                    required
            ...
            <div class="col-md-6 pl-5 pr-5">
                <label for="validationCustom03" class="form-label"
                    >Año de egreso nivel secundario</label
                >
                <input
                    type="number"
                    class="form-control"
