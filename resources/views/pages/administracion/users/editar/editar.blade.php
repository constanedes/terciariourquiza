@include('pages.administracion.users.editar.jscripts')
@extends('pages.administracion.administracion')
@section('page')
<div class="container">
    <form class="row g-3 needs-validation m-3 p-5" method="POST" novalidate action="/administracion/users/edit">
        @csrf
        @if ($errors->any())
        ...
        <div class="col-md-6 pl-5 pr-5">
            ...
            <input type="number" class="form-control" name="numdoc" value="{{$user->numdoc}}" required />
        ...
        <div class="col-md-6 pl-5 pr-5">
            ...
            <input type="text" class="form-control" id="validationCustom02" name="address" value="{{$user->address}}"
                required />
            <div class="valid-feedback">Looks good!</div>
        </div>
        ...
        <div class="col-md-6 pl-5 pr-5">
            ...
            <input class="form-control" name="nationality" value="{{$user->nationality}}" required />
            <div class="invalid-feedback">Please select a valid state.</div>
        </div>
        ...
        <div class="col-md-6 pl-5 pr-5">
            ...
            <input class="form-select" id="validationCustom04" name="title" value="{{$user->title}}" required />
            <div class="invalid-feedback">Please select a valid state.</div>
        </div>
        ...
        <div class="col-md-6 pl-5 pr-5">
            ...
            <input type="number" class="form-control" id="validationCustom03" name="yearofgraduation"
                value="{{$user->yearofgraduation}}" required />
            <div class="invalid-feedback">Please provide a valid city.</div>
        </div>
        <!-- Institucion -->
        <div class="col-md-6 pl-5 pr-5">
            <label for="validationCustom04" class="form-label">Institucion</label>
            <input class="form-control" type="text" id="institution" name="institution" value="{{$user->institution}}"
                required />
            <div class="invalid-feedback">Please select a valid state.</div>
        </div>
